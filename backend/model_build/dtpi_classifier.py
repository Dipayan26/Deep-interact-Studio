...
def train_dtpi_classifier(
    ...
    input_dim = int(hyperparams.get("chunk_model_dim", max(chem_dim, esm_dim))) if representation_mode == "chunked" else chem_dim + esm_dim
    ...
    print(
        f"[dtpi_train] device={device}  mode={representation_mode}  chem_dim={chem_dim}  esm_dim={esm_dim}  "
