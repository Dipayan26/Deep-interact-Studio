...
if data_ready:
    ...
    with bc1:
        st.slider(
            ...
            format="%d%%",
            on_change=_sync_rpi_negative_percent,
    ...
    with bc2:
        st.slider(
            ...
            format="%d%%",
            on_change=_sync_rpi_positive_percent,
...
est = _estimate_time(
    stats["rows"], stats["unique_rna"], mean_rna_len,
