...
_SCROLL_TOP_KEY = "dtpi_scroll_to_top"
...
if active_step == "Training":
    ...
    if st.button("Submit Training Job", type="primary", use_container_width=True, disabled=submit_disabled):
        ...
        with st.spinner("Submitting..."):
            try:
                ...
                st.session_state["dtpi_submitted_run_id"] = data["run_id"]
    ...
    submitted_run_id = st.session_state.get("dtpi_submitted_run_id", "")
    if submitted_run_id:
        if st.button("Check Model Results", type="primary", use_container_width=False, key="dtpi_check_model_results"):
